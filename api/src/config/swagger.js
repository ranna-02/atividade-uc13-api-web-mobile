...
const options = {
  definition: {
    ...
    tags: [
      ...
      { name: 'Consultas', description: 'Gerenciamento de consultas' },
      { name: 'Exames', description: 'Gerenciamento de exames' },
      { name: 'Resultados', description: 'Resultados de exames' },
      { name: 'Push Tokens', description: 'Tokens de notificações push' }
    ]
  },
